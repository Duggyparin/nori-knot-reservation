...
export default function LoginSupabase() {
  ...
  // Detect in‑app browser (Facebook, Instagram, Messenger)
  useEffect(() => {
    ...
    <div className="relative min-h-screen bg-black flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-8 w-full max-w-md shadow-2xl">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white/10 hover:bg-white/20 text-white font-medium py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 border border-white/20 disabled:opacity-50"
        >
